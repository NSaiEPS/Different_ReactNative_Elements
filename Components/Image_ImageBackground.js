...
const Image_ImageBackground = () => {
  ...
  const onPressHandler = () => {
    ...
    // Image
    // resizeMore->Strtch will fit within our width & height
    // Blur radius to blurr the image
    // Background Image as used as <div> in html & same as image 
    return (
        <ImageBackground
        style={styles.body}
          ...
          submitted ?
            <View style={styles.body}>
              ...
              <Image
                style={styles.image}
                source={{
                    uri:'https://raw.githubusercontent.com/mahdi-sharifimehr/RN-Tutorial-Main/RN-Tutorial-15/assets/done.png'
                }}
                resizeMode='stretch'
              />
            </View>
...
export default Image_ImageBackground
